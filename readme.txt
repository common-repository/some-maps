...
* Very customizable
* Uses jQuery [bMap](http://www.blocsoft.com/bmap/)

Some screens: [1](http://i.imgur.com/FFaYH.png), [2](http://i.imgur.com/7LFcX.png)
...
= 1.4 =
* Fixed some warnings, added more security to reduce ajax cross domain requests.
